...
from config.database import SessionLocal, quote_plus
...
executors = {'default': ThreadPoolExecutor(), 'processpool': ProcessPoolExecutor(5)}
...
class SchedulerUtil:
    ...
    def init_system_scheduler(cls):
        ...
        with SessionLocal() as session:
            job_list = JobDao.get_job_list_for_scheduler(session)
    ...
    @classmethod
    def close_system_scheduler(cls):
        """
        应用关闭时关闭定时任务
