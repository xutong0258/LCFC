...
class DictTypeDao:
    ...
    def get_dict_type_list(cls, db: Session, query_object: DictTypePageQueryModel, is_page: bool = False):
        ...
        dict_type_list = PageUtil.paginate(db, query, query_object.page_num, query_object.page_size, is_page)
...
class DictDataDao:
    ...
    @classmethod
    def count_dict_data_dao(cls, db: Session, dict_type: str):
        """
