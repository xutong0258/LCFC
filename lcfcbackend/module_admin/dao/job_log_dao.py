...
class JobLogDao:
    ...
    def get_job_log_list(cls, db: Session, query_object: JobLogPageQueryModel, is_page: bool = False):
        ...
        job_log_list = PageUtil.paginate(db, query, query_object.page_num, query_object.page_size, is_page)
    ...
    def delete_job_log_dao(cls, db: Session, job_log: JobLogModel):
        ...
        :return:
        """
        db.execute(delete(SysJobLog).where(SysJobLog.job_log_id.in_([job_log.job_log_id])))
