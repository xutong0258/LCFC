...
class DeptDao:
    ...
    @classmethod
    def get_children_dept_dao(cls, db: Session, dept_id: int):
        """
    ...
    @classmethod
    def update_dept_children_dao(cls, db: Session, update_dept: List):
        """
        更新子部门信息
    ...
    @classmethod
    def update_dept_status_normal_dao(cls, db: Session, dept_id_list: List):
        """
        批量更新部门状态为正常
    ...
    @classmethod
    def count_normal_children_dept_dao(cls, db: Session, dept_id: int):
        """
    ...
    @classmethod
    def count_children_dept_dao(cls, db: Session, dept_id: int):
        """
    ...
    @classmethod
    def count_dept_user_dao(cls, db: Session, dept_id: int):
        """
        根据部门id查询查询部门下的用户数量
