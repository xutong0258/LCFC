...
def get_monitor_cache_info(request: Request):
    # 获取全量数据
    cache_info_query_result = CacheService.get_cache_monitor_statistical_info_services(request)
    logger.info('获取成功')
...
def get_monitor_cache_name(request: Request):
    # 获取全量数据
...
def get_monitor_cache_key(request: Request, cache_name: str):
    # 获取全量数据
    cache_key_list_result = CacheService.get_cache_monitor_cache_key_services(request, cache_name)
    logger.info('获取成功')
...
def get_monitor_cache_value(request: Request, cache_name: str, cache_key: str):
    # 获取全量数据
    cache_value_list_result = CacheService.get_cache_monitor_cache_value_services(request, cache_name, cache_key)
    logger.info('获取成功')
...
def clear_monitor_cache_name(request: Request, cache_name: str):
    clear_cache_name_result = CacheService.clear_cache_monitor_cache_name_services(request, cache_name)
...
def clear_monitor_cache_key(request: Request, cache_key: str):
    clear_cache_key_result = CacheService.clear_cache_monitor_cache_key_services(request, cache_key)
...
def clear_monitor_cache_all(request: Request):
    clear_cache_all_result = CacheService.clear_cache_monitor_all_services(request)
