...
def get_system_menu_tree(request: Request,
...
def get_system_role_menu_tree(request: Request,
                                    role_id: int,
                                    query_db: Session = Depends(get_db),
                                    current_user: CurrentUserModel = Depends(LoginService.get_current_user)):
...
def get_system_menu_list(request: Request,
...
def add_system_menu(request: Request,
                          add_menu: MenuModel,
                          query_db: Session = Depends(get_db),
                          current_user: CurrentUserModel = Depends(LoginService.get_current_user)):
...
def edit_system_menu(request: Request,
                           edit_menu: MenuModel,
                           query_db: Session = Depends(get_db),
                           current_user: CurrentUserModel = Depends(LoginService.get_current_user)):
...
def delete_system_menu(request: Request, menu_ids: str, query_db: Session = Depends(get_db)):
...
def query_detail_system_menu(request: Request, menu_id: int, query_db: Session = Depends(get_db)):
