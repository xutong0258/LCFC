...
def get_system_operation_log_list(
    request: Request,
...
def clear_system_operation_log(request: Request, query_db: Session = Depends(get_db)):
...
def delete_system_operation_log(request: Request, oper_ids: str, query_db: Session = Depends(get_db)):
...
def export_system_operation_log_list(
    request: Request,
...
def clear_system_login_log(request: Request, query_db: Session = Depends(get_db)):
...
def delete_system_login_log(request: Request, info_ids: str, query_db: Session = Depends(get_db)):
...
def unlock_system_user(request: Request, user_name: str, query_db: Session = Depends(get_db)):
...
def export_system_login_log_list(
    request: Request,
