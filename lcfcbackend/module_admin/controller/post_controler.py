...
def delete_system_post(request: Request, post_ids: str, query_db: Session = Depends(get_db)):
...
def query_detail_system_post(request: Request, post_id: int, query_db: Session = Depends(get_db)):
