...
def get_system_dict_type_list(request: Request,
...
def add_system_dict_type(request: Request,
...
def edit_system_dict_type(request: Request,
...
@Log(title='字典类型', business_type=BusinessType.UPDATE)
def refresh_system_dict(request: Request, query_db: Session = Depends(get_db)):
...
def delete_system_dict_type(request: Request, dict_ids: str, query_db: Session = Depends(get_db)):
...
def query_system_dict_type_options(request: Request, query_db: Session = Depends(get_db)):
...
def query_detail_system_dict_type(request: Request, dict_id: int, query_db: Session = Depends(get_db)):
...
def export_system_dict_type_list(
    request: Request,
...
def query_system_dict_type_data(request: Request, dict_type: str, query_db: Session = Depends(get_db)):
    # 获取全量数据
    dict_data_query_result = DictDataService.query_dict_data_list_from_cache_services(
...
@dictController.get('/data/list', response_model=PageResponseModel,
                    dependencies=[Depends(CheckUserInterfaceAuth('system:dict:list'))])
def get_system_dict_data_list(request: Request,
...
def add_system_dict_data(request: Request,
...
def edit_system_dict_data(request: Request,
...
def delete_system_dict_data(request: Request, dict_codes: str, query_db: Session = Depends(get_db)):
...
def query_detail_system_dict_data(request: Request, dict_code: int, query_db: Session = Depends(get_db)):
...
def export_system_dict_data_list(request: Request, dict_data_page_query: DictDataPageQueryModel = Form(),
                                       query_db: Session = Depends(get_db)):
    # 获取全量数据
