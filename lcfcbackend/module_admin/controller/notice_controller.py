...
def delete_system_notice(request: Request, notice_ids: str, query_db: Session = Depends(get_db)):
...
def query_detail_system_post(request: Request, notice_id: int, query_db: Session = Depends(get_db)):
