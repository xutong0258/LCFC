...
class DeptService:
    ...
    @classmethod
    def get_dept_for_edit_option_services(
    ...
    @classmethod
    def check_dept_data_scope_services(cls, query_db:  Session, dept_id: int, data_scope_sql: str):
        """
        校验部门是否有数据权限service
    ...
    @classmethod
    def check_dept_name_unique_services(cls, query_db:  Session, page_object: DeptModel):
        """
        校验部门名称是否唯一service
    ...
    @classmethod
    def replace_first(cls, original_str: str, old_str: str, new_str: str):
        """
        工具方法：替换字符串
    ...
    @classmethod
    def update_parent_dept_status_normal(cls, query_db:  Session, dept: DeptModel):
        """
        更新父部门状态为正常
    ...
    @classmethod
    def update_dept_children(cls, query_db:  Session, dept_id: int, new_ancestors: str, old_ancestors: str):
        """
        更新子部门信息
