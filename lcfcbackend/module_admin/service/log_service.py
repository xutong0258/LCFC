...
class OperationLogService:
    ...
    @classmethod
    def get_operation_log_list_services(
    ...
    @classmethod
    def export_operation_log_list_services(cls, request: Request, operation_log_list: List):
        """
        导出操作日志信息service
        ...
        operation_type_list = DictDataService.query_dict_data_list_from_cache_services(
...
class LoginLogService:
    ...
    @classmethod
    def get_login_log_list_services(
    ...
    @classmethod
    def unlock_user_services(cls, request: Request, unlock_user: UnlockUser):
