...
class PostService:
    ...
    @classmethod
    def check_post_name_unique_services(cls, query_db:  Session, page_object: PostModel):
        """
        检查岗位名称是否唯一service
    ...
    @classmethod
    def check_post_code_unique_services(cls, query_db:  Session, page_object: PostModel):
        """
        检查岗位编码是否唯一service
