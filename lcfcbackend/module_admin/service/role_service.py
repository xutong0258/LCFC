...
class RoleService:
    ...
    def get_role_list_services(
        ...
        :return: 角色列表信息对象
        """
        role_list_result = RoleDao.get_role_list(query_db, query_object, data_scope_sql, is_page)

        return role_list_result

    @classmethod
    def check_role_allowed_services(cls, check_role: RoleModel):
        """
        校验角色是否允许操作service
    ...
    @classmethod
    def check_role_data_scope_services(cls, query_db:  Session, role_ids: str, data_scope_sql: str):
        """
        校验角色是否有数据权限service
    ...
    @classmethod
    def check_role_name_unique_services(cls, query_db:  Session, page_object: RoleModel):
        """
        校验角色名称是否唯一service
    ...
    @classmethod
    def check_role_key_unique_services(cls, query_db:  Session, page_object: RoleModel):
        """
        校验角色权限字符是否唯一service
    ...
    @classmethod
    def get_role_user_allocated_list_services(
    ...
    @classmethod
    def get_role_user_unallocated_list_services(
        cls, query_db:  Session, page_object: UserRolePageQueryModel, data_scope_sql: str, is_page: bool = False
    ):
        """
        根据角色id获取未分配用户列表
