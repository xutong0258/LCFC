...
from exceptions.exception import LoginException, ServiceException, ServiceWarning, NotFoundException
    ...
    def __call__(self, func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if content_type and (
                ...
                payload = asyncio.run(request.body())
            ...
            try:
                ...
                result = ResponseUtil.not_found(message=e.message)
            ...
            if self.log_type == 'login':
                ...
                current_user = LoginService.get_current_user(request, token, query_db)
